...
--------*/	
	...
	*treatment vars : 
	...
	global treatment "corrtreat pcorrtreat referral drugpres numofdrug antibiotic corrdrug pcorrdrug uselessdrug numedl numnonedl numedlprov numnonprovedl nonedldrug"
...
--------*/	
	...
	/* $control1 - clinic level:  
		...
		chi_med doctorid 
		thc_f_b_f04 vc_f_b_d2_14 thc_f_b_f10 (related to revenue)*/
	
	global control1 = "towncode countycode THC VC MVC angina diarrhea tuberc groupcode chi_med doctorid thc_f_b_f04 vc_f_b_d2_14 thc_f_b_f10 "
	...
	foreach x of varlist thc_f_b_f04 vc_f_b_d2_6 thc_f_b_f10 {
		di "missing count: variable - `x'"
...
--------*/		
	...
	keep $process $diagnosis $treatment $control1 $control2 $control3 $arm ///
		type patientload drugfee totfee
